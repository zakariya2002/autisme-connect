...
-- =====================================================
-- Ce script insère 15 profils d'éducateurs répartis dans toute la France
-- avec des données complètes et réalistes pour tester les fonctionnalités

-- Supprimer les profils de test existants (facultatif)
-- DELETE FROM educator_profiles WHERE user_id IS NULL;
...
-- =====================================================
-- AUTRES GRANDES VILLES (6 profils)
-- =====================================================
...
SELECT
  ...
  location as "Ville",
  specialties as "Spécialités",
  experience_years || ' ans' as "Expérience",
