    ...
    <div className="min-h-screen min-h-[100dvh] flex flex-col" style={{ backgroundColor: '#fdf9f4' }}>
      ...
      <div className="flex-1 max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 py-6 sm:py-8 w-full">
        ...
        <div className="bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden mb-6">
          <div className="px-5 py-4" style={{ background: 'linear-gradient(135deg, #41005c 0%, #5a1a75 100%)' }}>
            <div className="flex items-center gap-3">
              ...
              <div>
                <h2 className="text-lg font-bold text-white">Premium Actif</h2>
                <p className="text-white/80 text-sm">100% gratuit, sans engagement</p>
              </div>
            </div>
          </div>
          ...
          <div className="p-6">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 mb-6">
              <div className="flex items-center gap-3 p-3 rounded-xl" style={{ backgroundColor: '#f3e8ff' }}>
            ...
            <Link
              href="/pro/pricing"
              className="block w-full text-center px-5 py-3 rounded-xl font-medium transition hover:opacity-90"
        ...
        <div className="bg-white rounded-2xl shadow-sm border border-gray-100 p-5">
          <div className="flex items-start gap-4">
            <div className="w-10 h-10 rounded-full flex items-center justify-center flex-shrink-0" style={{ backgroundColor: '#e6f4f4' }}>
