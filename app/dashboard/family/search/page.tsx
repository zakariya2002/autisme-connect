                      ...
                      <div className="flex flex-col sm:flex-row sm:justify-between sm:items-start gap-3 sm:gap-4">
                        ...
                        <div className="hidden sm:flex flex-col gap-2 items-center ml-4">
                          ...
                          <Link
                            ...
                            className="inline-flex items-center justify-center gap-2 px-5 py-3 bg-gradient-to-r from-primary-600 to-purple-600 text-white rounded-xl hover:from-primary-700 hover:to-purple-700 text-sm font-bold shadow-lg hover:shadow-xl transition-all whitespace-nowrap group/btn"
                          >
