    ...
    <div className="min-h-screen bg-white">
      ...
      <nav className="bg-white border-b border-gray-100 sticky top-0 z-50" role="navigation" aria-label="Navigation principale">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          {/* Mobile Navigation */}
          {mobileMenuOpen && (
            <div id="mobile-menu-sap" className="xl:hidden py-4 border-t border-gray-100" role="menu">
              <div className="flex flex-col gap-3">
                ...
                <Link href="/pro/sap-accreditation" className="text-teal-600 font-medium py-2 focus:outline-none focus:ring-2 focus:ring-teal-500 rounded" role="menuitem" aria-current="page">Guide SAP</Link>
