...
export default function ProLandingPage() {
  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      {/* Modal Beta */}
      {showBeta && (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4" onClick={dismissBeta}>
          ...
          >
            {/* Header gradient */}
            <div className="relative px-6 pt-8 pb-14 text-center" style={{ background: 'linear-gradient(135deg, #41005c 0%, #6b21a8 50%, #41005c 100%)' }}>
              {/* Cercles décoratifs */}
              ...
              <div className="relative inline-flex flex-col items-center">
                <span className="inline-flex items-center gap-1.5 px-3 py-1 rounded-full text-[11px] font-bold tracking-wider text-white mb-4" style={{ backgroundColor: 'rgba(240, 135, 159, 0.8)', backdropFilter: 'blur(4px)' }}>
            ...
            <div className="bg-white px-6 pt-6 pb-6">
              ...
              <Link
                ...
                className="flex items-center justify-center gap-2 w-full px-5 py-3.5 rounded-xl font-bold text-white text-sm transition-all hover:shadow-lg hover:scale-[1.02] active:scale-[0.98]"
