        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between h-16 lg:h-20 items-center">
            ...
            <button
              ...
              aria-controls="mobile-menu-pricing"
          ...
          {/* Mobile Navigation */}
          {mobileMenuOpen && (
            <div id="mobile-menu-pricing" className="xl:hidden py-4 border-t border-gray-100" role="menu">
              <div className="flex flex-col gap-3">
                <Link href="/pro/pricing" className="text-teal-600 font-medium py-2 focus:outline-none focus:ring-2 focus:ring-teal-500 rounded" role="menuitem" aria-current="page">Tarifs</Link>
            ...
            {[
              ...
              <details key={index} className="bg-white rounded-xl shadow-md overflow-hidden group">
                <summary className="px-6 py-4 cursor-pointer font-semibold text-gray-900 hover:bg-gray-50 transition flex items-center justify-between">
                  {faq.q}
                  <svg className="w-5 h-5 text-primary-600 group-open:rotate-180 transition-transform flex-shrink-0 ml-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
