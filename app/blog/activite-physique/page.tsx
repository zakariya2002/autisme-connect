    ...
    <div className="min-h-screen bg-white">
      ...
      <article className="max-w-3xl mx-auto px-4 py-12">
        ...
        <div className="flex items-center gap-4 text-sm text-gray-500 mb-4">
          <span className="px-3 py-1 rounded-full text-sm font-medium" style={{ backgroundColor: 'rgba(34, 197, 94, 0.1)', color: '#22c55e' }}>
            Bien-être
          </span>
        ...
        <div className="prose prose-lg max-w-none">
          ...
          <h2 className="text-2xl font-bold text-gray-900 mt-10 mb-4">Les bienfaits prouvés de l'activité physique</h2>

          <h3 className="text-xl font-semibold text-gray-900 mt-6 mb-3">Sur le plan physique</h3>
          ...
          <h3 className="text-xl font-semibold text-gray-900 mt-6 mb-3">Sur le plan psychologique</h3>
          <ul className="list-disc pl-6 mb-6 text-gray-700 space-y-2">
          ...
          <h3 className="text-xl font-semibold text-gray-900 mt-6 mb-3">Sur le plan social</h3>
          <ul className="list-disc pl-6 mb-6 text-gray-700 space-y-2">
          ...
          <h2 className="text-2xl font-bold text-gray-900 mt-10 mb-4">Quels sports privilégier ?</h2>
          <p className="text-gray-700 mb-4">
            Le choix du sport dépend des préférences et du profil sensoriel de chaque personne. Voici quelques pistes :
          </p>

          <h3 className="text-xl font-semibold text-gray-900 mt-6 mb-3">Sports individuels</h3>
          <p className="text-gray-700 mb-4">
          ...
          <h3 className="text-xl font-semibold text-gray-900 mt-6 mb-3">Sports avec animaux</h3>
          <p className="text-gray-700 mb-4">
          ...
          <h3 className="text-xl font-semibold text-gray-900 mt-6 mb-3">Sports collectifs adaptés</h3>
          <p className="text-gray-700 mb-4">
          ...
          <div className="bg-green-50 border-l-4 border-green-500 p-6 my-8 rounded-r-lg">
            <h4 className="font-bold text-green-800 mb-2">Le saviez-vous ?</h4>
          ...
          <h2 className="text-2xl font-bold text-gray-900 mt-10 mb-4">Comment adapter la pratique ?</h2>

          <h3 className="text-xl font-semibold text-gray-900 mt-6 mb-3">1. Préparer la séance</h3>
          <p className="text-gray-700 mb-4">
          ...
          <h3 className="text-xl font-semibold text-gray-900 mt-6 mb-3">2. Adapter l'environnement</h3>
          <p className="text-gray-700 mb-4">
          ...
          <h3 className="text-xl font-semibold text-gray-900 mt-6 mb-3">3. Communiquer clairement</h3>
          <p className="text-gray-700 mb-4">
          ...
          <h3 className="text-xl font-semibold text-gray-900 mt-6 mb-3">4. Respecter le rythme</h3>
          <p className="text-gray-700 mb-4">
            Acceptez que certains jours soient moins productifs. Proposez des pauses régulières. Ne forcez jamais la participation.
          </p>

          <h3 className="text-xl font-semibold text-gray-900 mt-6 mb-3">5. Valoriser les progrès</h3>
          <p className="text-gray-700 mb-4">
            Chaque petit progrès compte. Utilisez des renforcements positifs adaptés aux intérêts de la personne.
          </p>

          <h2 className="text-2xl font-bold text-gray-900 mt-10 mb-4">Activités physiques à la maison</h2>
          <p className="text-gray-700 mb-4">
          ...
          <h2 className="text-2xl font-bold text-gray-900 mt-10 mb-4">Trouver le bon encadrement</h2>
          <p className="text-gray-700 mb-4">
          ...
          <div className="bg-teal-50 border-l-4 border-teal-500 p-6 my-8 rounded-r-lg">
            <h4 className="font-bold text-teal-800 mb-2">Sur NeuroCare</h4>
          ...
          <div className="grid md:grid-cols-2 gap-6">
            ...
            <Link href="/blog/nutrition" className="bg-white rounded-xl p-6 shadow-sm hover:shadow-md transition-shadow flex gap-4">
              ...
              <div>
                ...
                <p className="text-sm text-gray-600 line-clamp-2">Les bases d'une alimentation adaptée.</p>
              </div>
            </Link>
          </div>
        </div>
