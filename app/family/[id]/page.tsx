            ...
            <div className="grid grid-cols-1 gap-6">
              ...
              <div className="bg-gray-50 rounded-lg p-6">
                <h2 className="text-xl font-semibold text-gray-900 mb-4 flex items-center">
                  <svg className="w-6 h-6 mr-2 text-primary-600" fill="none" stroke="currentColor" viewBox="0 0 24 24" aria-hidden="true">
              ...
              {userRole === 'educator' && hasConversation ? (
                ...
                <div className="bg-primary-50 border-l-4 border-primary-500 p-6 rounded-r-lg" role="alert">
                  <div className="flex">
                    <div className="flex-shrink-0">
