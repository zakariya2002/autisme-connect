...
const professionTypes = [
  ...
  { label: 'Sport adapté', value: 'sport_adapte', desc: 'Activité physique adaptée, TND', color: '#d4547a', bg: '#fff0f4',
    ...
    <div className="min-h-screen overflow-x-hidden bg-white">
        ...
        <div className="max-w-7xl mx-auto px-4 lg:px-8">
          ...
          <div className="hidden lg:flex items-center h-14 xl:h-16">
            <nav className="flex-1 flex items-center justify-end gap-0.5 xl:gap-1" aria-label="Navigation principale gauche">
              ...
              <Link href="/annonces" className="group flex items-center gap-1 xl:gap-1.5 px-2 xl:px-3 py-1.5 xl:py-2 text-xs xl:text-sm text-white/90 hover:text-white hover:bg-white/15 rounded-md font-medium transition-all whitespace-nowrap">
      ...
      <section className="relative min-h-[340px] sm:min-h-[400px] lg:min-h-[440px] mt-14 xl:mt-16 flex items-center">
        <div className="absolute inset-0">
          <Image src="/images/hero-test.jpg" alt="Professionnels accompagnant un enfant avec des besoins neurodéveloppementaux" fill priority sizes="100vw" className="object-cover object-center" />
        </div>
      ...
      <section className="py-10 lg:py-20 px-6" style={{ backgroundColor: '#fdf9f4' }} aria-labelledby="how-it-works">
        <div className="max-w-4xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 relative">
            <div className="hidden md:block absolute top-12 left-[calc(16.67%+2rem)] right-[calc(16.67%+2rem)] h-px border-t-2 border-dashed border-gray-200" />
            {[
              { n: '1', title: 'Recherchez', desc: 'Indiquez le type de professionnel, le trouble de votre enfant ou votre ville.', picto: '/images/pictos/picto-17.png' },
              { n: '2', title: 'Comparez', desc: 'Consultez les profils détaillés : diplômes, spécialisations, méthodes, disponibilités.', picto: '/images/pictos/picto-21.png' },
              { n: '3', title: 'Contactez', desc: 'Échangez directement avec le professionnel qui correspond à vos besoins.', picto: '/images/pictos/picto-19.png' },
        ...
        <div className="max-w-5xl mx-auto">
          <div className="rounded-2xl overflow-hidden grid grid-cols-1 lg:grid-cols-2 border border-[#027e7e]/15" style={{ backgroundColor: '#f0fafa' }}>
            ...
            <div className="flex flex-col justify-center px-8 pb-10 lg:py-12 lg:px-10 lg:pr-14">
              ...
              <p className="text-gray-500 text-sm lg:text-base mb-7 leading-relaxed">
