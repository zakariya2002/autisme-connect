          ...
          <div className="bg-white rounded-2xl p-6 sm:p-8 shadow-md">
            ...
            <div className="space-y-3 text-gray-700" style={{ fontFamily: 'Open Sans, sans-serif' }}>
              <p className="flex items-start gap-3">
                <svg className="w-5 h-5 flex-shrink-0 mt-0.5" style={{ color: '#027e7e' }} fill="currentColor" viewBox="0 0 20 20" aria-hidden="true">
        ...
        <div className="max-w-5xl mx-auto">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4 sm:gap-6">
            <div className="text-center">
              <div className="w-16 h-16 rounded-full flex items-center justify-center mx-auto mb-3 text-white text-xl font-bold" style={{ backgroundColor: '#027e7e' }}>
                1
              </div>
              <h3 className="font-bold text-gray-900 mb-1" style={{ fontFamily: 'Verdana, sans-serif' }}>Créez votre compte</h3>
              <p className="text-gray-600 text-sm" style={{ fontFamily: 'Open Sans, sans-serif' }}>
            ...
            <div className="text-center">
              <div className="w-16 h-16 rounded-full flex items-center justify-center mx-auto mb-3 text-white text-xl font-bold" style={{ backgroundColor: '#3a9e9e' }}>
                2
              </div>
              <h3 className="font-bold text-gray-900 mb-1" style={{ fontFamily: 'Verdana, sans-serif' }}>Recherchez</h3>
              <p className="text-gray-600 text-sm" style={{ fontFamily: 'Open Sans, sans-serif' }}>
            ...
            <div className="text-center">
              <div className="w-16 h-16 rounded-full flex items-center justify-center mx-auto mb-3 text-white text-xl font-bold" style={{ backgroundColor: '#6bbebe' }}>
                3
              </div>
              <h3 className="font-bold text-gray-900 mb-1" style={{ fontFamily: 'Verdana, sans-serif' }}>Contactez</h3>
              <p className="text-gray-600 text-sm" style={{ fontFamily: 'Open Sans, sans-serif' }}>
            ...
            <div className="text-center">
              <div className="w-16 h-16 rounded-full flex items-center justify-center mx-auto mb-3 text-white text-xl font-bold" style={{ backgroundColor: '#9bd4d4' }}>
                4
              </div>
              <h3 className="font-bold text-gray-900 mb-1" style={{ fontFamily: 'Verdana, sans-serif' }}>Réservez</h3>
              <p className="text-gray-600 text-sm" style={{ fontFamily: 'Open Sans, sans-serif' }}>
        ...
        <div className="max-w-3xl mx-auto">
          <div className="rounded-2xl p-8 sm:p-10 text-center text-white" style={{ backgroundColor: '#027e7e' }}>
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <Link
                href="/search"
                className="inline-flex items-center justify-center px-6 py-3 bg-white rounded-lg font-semibold transition-all hover:opacity-90"
                style={{ color: '#027e7e' }}
              ...
              <Link
                href="/auth/signup"
                className="inline-flex items-center justify-center px-6 py-3 border-2 border-white rounded-lg font-semibold text-white transition-all hover:bg-white/10"
