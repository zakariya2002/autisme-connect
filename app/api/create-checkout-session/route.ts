...
export async function POST() {
  return NextResponse.json(
    {
      error: 'Les abonnements ont été désactivés. Toutes les fonctionnalités sont désormais gratuites.',
      info: 'Consultez /pro/pricing pour en savoir plus sur notre modèle économique.'
    },
