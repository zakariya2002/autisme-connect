        ...
        {!success && (
          <div className="mt-6 bg-blue-50 border border-blue-200 rounded-lg p-4">
            <div className="flex items-start">
              <svg className="w-5 h-5 text-blue-600 mt-0.5 mr-3 flex-shrink-0" fill="currentColor" viewBox="0 0 20 20" aria-hidden="true">
        ...
        <div className="mt-6 text-center">
          <div className="text-xs text-gray-600 space-y-2">
            <div className="flex items-center justify-center space-x-4">
              <Link href="/politique-confidentialite" className="hover:text-primary-600 transition-colors underline">
                Politique de confidentialité
              </Link>
              <span>•</span>
              <Link href="/cgu" className="hover:text-primary-600 transition-colors underline">
                CGU
              </Link>
              <span>•</span>
              <Link href="/mentions-legales" className="hover:text-primary-600 transition-colors underline">
                Mentions légales
              </Link>
            </div>
          </div>
