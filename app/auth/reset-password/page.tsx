          ...
          {success ? (
            <div className="text-center" role="alert" aria-live="assertive">
              ...
              <div className="animate-pulse text-primary-600">
                <svg className="animate-spin h-5 w-5 mx-auto" fill="none" viewBox="0 0 24 24" aria-hidden="true">
            ...
            <form className="space-y-6" onSubmit={handleSubmit}>
              ...
              <div>
                ...
                {confirmPassword && password !== confirmPassword && (
                  <p className="mt-1 text-xs text-red-600" role="alert" aria-live="polite">Les mots de passe ne correspondent pas</p>
                )}
                {confirmPassword && password === confirmPassword && (
                  <p className="mt-1 text-xs text-green-600 flex items-center" role="status" aria-live="polite">
