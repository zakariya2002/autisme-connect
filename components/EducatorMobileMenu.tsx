  ...
  return (
    <>
      <button
        ...
        className="md:hidden p-1 text-white transition-colors duration-200"
          ...
          >
            ...
            <nav className="flex flex-col gap-2">
              <Link
                ...
                onClick={handleClose}
                className="bg-gradient-to-r from-emerald-500 via-teal-500 to-cyan-500 text-white hover:from-emerald-600 hover:via-teal-600 hover:to-cyan-600 py-3 px-4 rounded-xl font-bold transition-all duration-200 flex items-center gap-3 shadow-lg"
              >
                ...
                <span className="ml-auto text-xs bg-white/20 px-2 py-1 rounded-full" aria-hidden="true">🏠</span>
              </Link>
              ...
              <button
                ...
                className="text-red-600 bg-red-50 hover:bg-red-100 py-3 px-4 rounded-lg font-medium transition-all duration-200 flex items-center gap-3 w-full text-left"
              >
                <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24" aria-hidden="true">
