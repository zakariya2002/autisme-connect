        ...
        <div className="relative flex flex-col">
          ...
          <div className="px-5 py-4 border-b border-gray-100">
            ...
            {isPremium ? (
              ...
              <div className="mt-2 px-3 py-1.5 rounded-lg text-center" style={{ backgroundColor: 'rgba(65, 0, 92, 0.1)' }}>
                <p className="text-xs font-semibold" style={{ color: '#41005c' }}>Compte gratuit</p>
              </div>
            )}
          </div>
            ...
            <div className="flex flex-col gap-2">
              ...
              {isPremium ? (
                ...
                <Link
                  href="/pro/pricing"
                  onClick={closeMenu}
                  className="text-white px-4 py-3 rounded-lg font-medium text-center transition-all duration-200 shadow-md hover:shadow-lg hover:opacity-90 flex items-center justify-center gap-3"
