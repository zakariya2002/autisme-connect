        ...
        <>
          ...
          <div className="fixed top-0 right-0 h-full w-64 bg-white shadow-xl z-50 p-6">
            ...
            <nav className="mt-8 flex flex-col gap-4">
              <Link href="/" onClick={() => setIsOpen(false)} className="text-gray-700 hover:text-primary-600 py-2 font-medium">
                Accueil
              </Link>
              <Link href="/about" onClick={() => setIsOpen(false)} className="text-gray-700 hover:text-primary-600 py-2 font-medium">
                Qui sommes-nous ?
              </Link>
              ...
              <Link href="/contact" onClick={() => setIsOpen(false)} className="text-gray-700 hover:text-primary-600 py-2 font-medium">
                Contact
              </Link>
